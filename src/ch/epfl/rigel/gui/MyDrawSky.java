    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try (InputStream hs = resourceStream("/hygdata_v3.csv")) {
            StarCatalogue catalogue = new StarCatalogue.Builder()
                    ...
                    .build();
            ZonedDateTime when = ZonedDateTime.parse("2001-04-05T07:15:00+01:00");
            GeographicCoordinates where = GeographicCoordinates.ofDeg(33.5, -7.6);
            HorizontalCoordinates projCenter = HorizontalCoordinates.ofDeg(45,  10);
